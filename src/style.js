const styles = {
  ...
  heading2:
    "font-poppins font-bold xs:text-[45.6px] text-black  text-[38px] text-white xs:leading-[72.96px] leading-[63.46px] w-full",
  heading3:
    "font-poppins font-semibold text-[32.5px] text-white leading-[50.875px] w-full",
